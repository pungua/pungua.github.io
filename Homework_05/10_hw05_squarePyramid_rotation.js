...
import { squarePyramid } from './squarePyramid.js'; // 사각뿔 라이브러리
...
const cameraCircleSpeed = 90.0; // x,z
const cameraYspeed = 45.0;
const cube = new squarePyramid(gl); // cube 대신 pyramid
...
function render() {
    ...
    // Model transformation matrix -> model은 움직이지 않는다.
